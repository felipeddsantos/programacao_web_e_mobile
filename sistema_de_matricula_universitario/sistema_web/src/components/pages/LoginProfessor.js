...
function LoginProfessor(props){
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            console.log("Dentro da página de login do professor")
        }
    }, [mostrarMensagem])    

    const logarProfessor = () => {

        let professorInserido = {               
            
            registro: registro,
            senha: senha
        }

        console.log(professorInserido)

        axios.post("http://localhost:8000/login/professor", professorInserido, axiosConfig)
            ...
            .catch((err) => {
                ...
                console.log("Problema ao logar professor: ", err)
    ...
    if(login)
        ...
        return <Redirect to = {"/professor/" + String(read_cookie(props.usuario.registro))}/>
        ...
        <Container style = {{marginTop: "50px"}}>
            ...
            <Form style = {{margin: "15px"}}>
                ...
                <Button style = {{margin: "10px", float: "left"}} variant = "success"
                    onClick = {logarProfessor}>Realizar Login</Button>
            </Form>
            <br></br>
            <br></br>
