...
function CadastroAluno(){
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            console.log("Dentro da página de cadastro do aluno")
        }
    }, [mostrarMensagem])    
    ...
    const inserirAluno = () => {
        ...
        if(senha === senha2){
            ...
            axios.post("http://localhost:8000/cadastro/aluno", alunoInserido, axiosConfig)
                ...
                .catch((err) => {
                    ...
                    console.log("Problema ao inserir aluno: ", err)
        ...
        <Container style = {{marginTop: "50px"}}>
            ...
            <Form style = {{margin: "15px"}}>
                ...
                <Button style = {{margin: "10px", float: "left"}}  variant = "success"
                    onClick = {inserirAluno}>Realizar Cadastro</Button>
            </Form>
            <br></br>
            <br></br>
