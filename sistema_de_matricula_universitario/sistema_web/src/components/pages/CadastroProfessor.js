...
function CadastroProfessor(){
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            console.log("Dentro da página de cadastro do professor")
        }
    }, [mostrarMensagem])    
    ...
    const inserirProfessor = () => {
        ...
        if(senha === senha2){
            ...
            axios.post("http://localhost:8000/cadastro/professor", professorInserido, axiosConfig)
                ...
                .catch((err) => {
                    ...
                    console.log("Problema ao inserir professor: ", err)
        ...
        <Container style = {{marginTop: "50px"}}>
            ...
            <Form style = {{margin: "15px"}}>
                ...
                <Button style = {{margin: "10px", float: "left"}} variant = "success"
                    onClick = {inserirProfessor}>Realizar Cadastro</Button>
            </Form>
            <br></br>
            <br></br>
